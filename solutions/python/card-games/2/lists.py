...
def card_average(hand):
    ...
    return sum(hand)/number_of_cards
...
def approx_average_is_average(hand):
    ...
    return actual_average == approx_average or actual_average == median
...
def average_even_is_average_odd(hand):
    ...
    even_ave = card_average(even_positions)
    
    odd_positions = hand[1::2]
    odd_ave = card_average(odd_positions)

    return even_ave == odd_ave
